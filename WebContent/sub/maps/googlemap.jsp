...
function setCenter(lat_str, lng_str) {
	...
	if(lat_str>0 && lng_str>0) { marker_latlng = new google.maps.LatLng(lat, lng); map.setZoom(15); }
	else { marker_latlng = new google.maps.LatLng(37.5663889, 126.9997222); map.setZoom(10); }
	
	var marker_image = 'images/photo_marker.png';
...
getFOV = function(focal_length) {
	...
	var fov = (2 * Math.atan(diagonalLength / (2 * focal_length))) * 180 / Math.PI;
...
function createViewMarker(point) {
	var marker_image = 'images/view_marker.png';
